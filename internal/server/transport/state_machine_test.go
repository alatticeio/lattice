...
func TestStateMachine_ValidTransitions(t *testing.T) {
	tests := []struct {
		...
		{"probing→lrp-ready", StateProbing, StateLRPReady, false},
		{"probing→failed", StateProbing, StateFailed, false},
		{"lrp-ready→ice-ready", StateLRPReady, StateICEReady, false},
		{"lrp-ready→failed", StateLRPReady, StateFailed, false},
		{"lrp-ready→closed", StateLRPReady, StateClosed, false},
		...
		{"ice-ready→lrp-ready", StateICEReady, StateLRPReady, true},

...
基于 MCP 规范的 **Streamable HTTP** 传输（2026-03-26 规范），单个 HTTP 端点处理所有请求。
...
- MCP 规范：https://modelcontextprotocol.io/specification/2026-03-26
- TypeScript SDK：`@modelcontextprotocol/sdk`
- Streamable HTTP 传输规范：MCP 2026-03-26 Section 3.2
